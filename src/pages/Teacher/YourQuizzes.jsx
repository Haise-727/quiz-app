  ...
  return (
    <div className="bg-[hsl(var(--muted))]/40 rounded-xl p-4 border border-[hsl(var(--border))]">
      <div className="flex items-center gap-3 mb-3">
        <span className="w-7 h-7 rounded-full bg-gradient-to-br from-[#e85a19] to-[#f5af19] text-white flex items-center justify-center font-bold text-xs shrink-0">{index + 1}</span>
    ...
    <div className="min-h-screen w-screen bg-gradient-to-br from-[#f12711] via-[#e85a19] to-[#f5af19] relative overflow-x-hidden">
      ...
      <div className="relative z-10 px-6 md:px-10 pb-6">
        <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-3xl md:text-4xl font-black text-white drop-shadow">Your Quizzes 📋</h1>
          <p className="text-white/70 mt-1">{quizzes.length} quiz{quizzes.length !== 1 ? 'zes' : ''} created</p>
        </motion.div>
      </div>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-6">
            ...
            <Button onClick={() => navigate('/teacher/home')} variant="default" size="sm"
              className="gap-2 bg-gradient-to-r from-[#e85a19] to-[#f5af19] text-white border-0 hover:opacity-90 shrink-0 ml-auto">
          ...
          {quizzes.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <Button onClick={() => navigate('/teacher/home')}
                className="gap-2 bg-gradient-to-r from-[#e85a19] to-[#f5af19] text-white border-0">
              ...
              {quizzes.filter(q =>
                ...
                <motion.div key={quiz.id} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
                  <Card className="border-0 shadow-md hover:shadow-lg transition-all overflow-hidden group">
                    <div className={`h-1.5 bg-gradient-to-r ${quiz.active ? 'from-[#e85a19] to-[#f5af19]' : 'from-gray-300 to-gray-400'}`} />
                    <CardContent className="pt-4 pb-5">
                      ...
                      <div className="flex items-center justify-between bg-[hsl(var(--muted))] rounded-xl px-3 py-2 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-mono font-black text-[#e85a19] tracking-widest">{quiz.code}</span>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
          <DialogHeader className="shrink-0 pb-4 border-b border-[hsl(var(--border))]">
            ...
            <div className="flex items-center gap-3 pt-2 flex-wrap">
              ...
              <span className="font-mono font-black text-[#e85a19] text-sm bg-[#fff8f5] px-2 py-0.5 rounded border border-[#f5af19]">{detailsQuiz?.code}</span>
            </div>
          </DialogHeader>
